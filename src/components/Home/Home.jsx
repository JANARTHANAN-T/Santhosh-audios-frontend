    ...
    <div className="bg-gradient-to-r from-sky-500 to-indigo-500 h-[65vh] pt-16 px-5">
      <div className="grid grid-cols-1 lg:grid-cols-2 flex items-center">
        ...
        <div>
          ...
          <div className="font-thin text-2xl md:text-4xl font-mono pt-5">&nbsp; It takes months to</div>
          </div>
          <div className="font-thin text-2xl md:text-4xl font-mono">&nbsp; &nbsp; find customer... </div>
          <div className="flex">
          <div className="font-thin text-2xl md:text-4xl font-mono ">&nbsp; &nbsp;Seconds to lose on.&nbsp;</div>
